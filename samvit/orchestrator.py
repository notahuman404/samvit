...
from samvit.core.checkpoint import CheckpointManager
from samvit.core.gemini_manager import GeminiModelManager
...
def _run(label: str, fn, *args, **kwargs) -> Any:
    ...
    try:
        ...
        from samvit.core.models import Issue, Severity, StageResult
        return StageResult(
            stage=label,
